...
function FundPage() {
  ...
  const account = { bank: "Paga MFB", number: "8106540922", name: "VERNEX / DENNY O." };
  ...
  return (
    <AppShell>
          ...
          <dl className="relative mt-4 space-y-3">
            <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
              <div className="min-w-0">
                ...
                <dd className="truncate text-sm font-bold text-white">{account.bank}</dd>
              </div>
            </div>
            <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
              <div className="min-w-0">
              ...
              <button
                onClick={() => copy(account.number, "num", "Account number")}
            ...
            <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
              <div className="min-w-0">
                ...
                <dd className="truncate text-sm font-bold text-white">{account.name}</dd>
              </div>
            </div>
          </dl>
      ...
      <section className="px-5 pt-6">
        ...
        <button className="flex w-full items-center gap-3 rounded-2xl border border-border bg-surface p-4 text-left shadow-card-elev hover:bg-surface-2 transition">
